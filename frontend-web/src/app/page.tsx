...
const CAPABILITIES = [
  ...
  { icon: Zap,      title: "Workflow automation",      desc: "Pre-call enrichment, in-call actions and post-call follow-ups — defined visually, no developer required." },
    ...
    <div className="min-h-screen bg-[#080b12] text-white" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <section className="py-20 px-6 flex justify-center">
        <div className="w-full max-w-2xl rounded-2xl border border-white/10 bg-[#0f1420] overflow-hidden shadow-2xl">
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-white/8 bg-[#0c1019]">
            <div className="flex items-center gap-3">
              ...
              <span className="text-neutral-400 text-sm font-mono">+91 98765 43210 · Live call</span>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {CAPABILITIES.map(cap => (
              <div key={cap.title} className="p-6 rounded-2xl border border-white/8 bg-white/2 hover:border-blue-500/30 hover:bg-blue-500/4 transition-all">
          ...
          <div className="p-8 rounded-2xl border border-white/10 bg-[#0f1420] space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" placeholder="Your name" className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-neutral-600 focus:outline-none focus:border-blue-500/50" />
              </div>
              <div>
                <label className="text-neutral-400 text-xs mb-1.5 block">Email</label>
                <input type="email" placeholder="you@firm.com" className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-neutral-600 focus:outline-none focus:border-blue-500/50" />
              </div>
            </div>
            <div>
              <label className="text-neutral-400 text-xs mb-1.5 block">Practice type</label>
              <input type="text" placeholder="e.g. Criminal law firm, 10 lawyers" className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-neutral-600 focus:outline-none focus:border-blue-500/50" />
            </div>
            <div>
              <label className="text-neutral-400 text-xs mb-1.5 block">What should the agent do?</label>
              <textarea rows={3} placeholder="e.g. Answer inbound calls, qualify bail matters, book consultations..." className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm placeholder-neutral-600 focus:outline-none focus:border-blue-500/50 resize-none" />
            </div>
